...
<!-- MarkdownTOC autolink="true" autoanchor="true" levels="1,2,3,4" indent=":point_right: "-->

- [General](#general)
":point_right:- [Device setup and calibration](#device-setup-and-calibration)
":point_right:":point_right:- [Hardware configuration](#hardware-configuration)
":point_right:":point_right:- [Calibrate latency](#calibrate-latency)
":point_right:":point_right:- [Calibrate inputs](#calibrate-inputs)
":point_right:":point_right:- [Air parameters](#air-parameters)
":point_right:- [Signal panel](#signal-panel)
":point_right:- [Information panel](#information-panel)
- [Methods](#methods)
":point_right:- [General](#general-1)
":point_right:- [Impedance Tube \(ISO 10534-2\)](#impedance-tube-iso-10534-2)
":point_right:":point_right:- [Tube parameters](#tube-parameters)
":point_right:":point_right:- [One-Mic measurement](#one-mic-measurement)
":point_right:":point_right:- [Two-Mic measurement](#two-mic-measurement)
":point_right:":point_right:":point_right:- [Calibrate the impedance tube system](#calibrate-the-impedance-tube-system)
":point_right:":point_right:- [Information panel](#information-panel-1)
":point_right:":point_right:- [Results visualization](#results-visualization)
":point_right:- [Transmission Tube \(ASTM 2611\)](#transmission-tube-astm-2611)
":point_right:":point_right:- [Tube parameters](#tube-parameters-1)
":point_right:":point_right:- [One-Mic measurement](#one-mic-measurement-1)
":point_right:":point_right:- [Two-Mic measurement](#two-mic-measurement-1)
":point_right:":point_right:- [Four-Mic measurement](#four-mic-measurement)
":point_right:":point_right:":point_right:- [Calibrate the transmission tube system](#calibrate-the-transmission-tube-system)
":point_right:":point_right:- [Measure information](#measure-information)
":point_right:":point_right:- [Results visualization](#results-visualization-1)
