...
if ~isfield(app.ExtVar,'UPVRobot')
    app.ExtVar.UPVRobot = struct('XLen',[],'YLen',[],'ZLen',[],'XYSpeed',[],'MaxXYSpeed',[],'ZSpeed',[],...
        ...
        'RobotURLmove',[],'RobotURLpos',[],'RobotURLstatus',[],'RobotURLreboot',[],'M5StackURLX',[],'M5StackURLY1',[],'M5StackURLY2',[],...
    'M5StackXAttempt',0,'M5StackY1Attempt',0,'M5StackY2Attempt',0,...    
...
app.ExtVar.UPVRobot.RobotURLmove = 'http://172.18.224.210/movexyz';
app.ExtVar.UPVRobot.RobotURLpos = 'http://172.18.224.210/position';
app.ExtVar.UPVRobot.RobotURLstatus = 'http://172.18.224.210/status';
app.ExtVar.UPVRobot.RobotURLreboot = 'http://172.18.224.210/reboot';

% M5Stack URL to check position
app.ExtVar.UPVRobot.M5StackURLX = 'http://172.18.224.211/';
app.ExtVar.UPVRobot.M5StackURLY1 = 'http://172.18.224.212/';
app.ExtVar.UPVRobot.M5StackURLY2 = 'http://172.18.224.213/';
